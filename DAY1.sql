CREATE TABLE countries(
        ...
        INSERT INTO developers(name,salary,prog_lang) VALUES('Cüneyt',4000,'Java');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Filiz',5000,'JavaScript');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Tarık',5000,'Java');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Ferit',4000,'JavaScript');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Adile',6000,'Java');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Şevket',6000,'Html');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Nalan',5500,'Css');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Ayşe',5000,'Java');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Kamil',4500,'Html');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Yavuz',4500,'Css');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Leyla',7000,'C++');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Zeki',4000,'C#');
        INSERT INTO developers(name,salary,prog_lang) VALUES('Metin',4000,'C#');
